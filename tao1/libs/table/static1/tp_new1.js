...
//        main.click(function(){ focus(); });
        ...
        $('<nav style="z-index:1; top:0px; bottom:0px; right:0px; padding-right:20px; position:absolute;"><ul class="pagination pagination-sm"></ul></nav>').appendTo(statusbar);
...
//        });
        ...
        function init_event(){
            ...
            $act.on('click', '.del_row',  function() { deleteRow();  return false; });
