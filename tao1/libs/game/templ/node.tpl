...
var keys, localPlayer, remotePlayers, ws, testvar, object3D ;
...
function Player(startX, startY, is_local) {
	var x = startX, y = startY, id, moveAmount = 1.8, mesh, a=0, b= 0, la=0, lb= 0, z=0;
...
{#            if (y) localPlayer.setA( y );#}
{#	        if (x) localPlayer.setB( x );#}
        }    }, false);
