...
/** GAME VARIABLES */
var canvas, /*Canvas DOM el*/ ctx,/* Canvas rendering context*/ keys,	/* Keyboard input*/ localPlayer, remotePlayers, socket;
/** GAME INITIALISATION */
function init() {
...
function setEventHandlers() {
    ...
    ws.onmessage = function(event){
        ...
        if(msg.e == 'chat') {
            ...
            if (!movePlayer) {
                console.log("Player not found: "+msg.id+' msg.msg'+msg.msg );   //TODO ошибка непонятно почему id нету у одного из игроко, почемуто не заносится в масив удаленые игроки
                return;
            }
    ...
    ws.onclose = function(event)  {  console.log("Disconnected from socket server");    };
