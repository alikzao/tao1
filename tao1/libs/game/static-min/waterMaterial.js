(function () {
    WaterMaterial = function (name, scene, light) {
        ...
        this.bumpTexture = new BABYLON.Texture("/static/game/babylon/water/Shaders/Water/bump.png", scene);
        ...
        this.refractionTexture.onBeforeRender = function() { BABYLON.clipPlane = new BABYLON.Plane(0, 1, 0, 0); };
        this.refractionTexture.onAfterRender = function() { BABYLON.clipPlane = null; };
    ...
    // Properties
    WaterMaterial.prototype.needAlphaBlending = function () { return false; };
    WaterMaterial.prototype.needAlphaTesting = function () { return false; };
    ...
    WaterMaterial.prototype.isReady = function (mesh) {
        ...
        if (this.bumpTexture && !this.bumpTexture.isReady) return false;
        this._effect = engine.createEffect("/static/game/babylon/water/Shaders/Water/water",
            ["position", "normal", "uv"],
