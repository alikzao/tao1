var launch = function () {
    ...
    // Babylon
    BABYLON.Engine.ShadersRepository = "/static/game/babylon/Babylon/Shaders";
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("static/game/babylon/Samples/Scenes/WorldMonger/Assets/skybox/skybox", scene);
    ...
    // Grounds
    var ground = BABYLON.Mesh.CreateGroundFromHeightMap("ground", "static/game/babylon/Samples/Scenes/WorldMonger/Assets/heightMap.png", 100, 100, 100, 0, 12, scene, true);
    ...
    extraGroundMaterial.diffuseTexture = new BABYLON.Texture("static/game/babylon/Samples/Scenes/WorldMonger/Shaders/Ground/sand.jpg", scene);
    ...
    var postProcess1 = new BABYLON.PostProcess("Down sample", "static/game/Samples/Scenes/WorldMonger/postprocesses/downsample", ["screenSize", "highlightThreshold"], null, 0.5, camera, BABYLON.Texture.DEFAULT_SAMPLINGMODE);
    ...
    var postProcess4 = new BABYLON.PostProcess("Final compose", "static/game/Samples/Scenes/WorldMonger/postprocesses/compose", ["sceneIntensity", "glowIntensity", "highlightIntensity"], ["sceneSampler"], 1, camera);
    ...
    var renderFunction = function () {
        ...
        else if (camera.beta > (Math.PI / 2) * 0.92) camera.beta = (Math.PI / 2) * 0.92;
    ...
    // Launch render loop
    scene.executeWhenReady(function() { engine.runRenderLoop(renderFunction); });
    // Resize
    ...
    // Sliders
    $("#slider-vertical").slider({ orientation: "vertical", range: "min", min: 2, max: 15, value: 5,
        slide: function (event, ui) { elevationControl.radius = ui.value; }
    });

    $("#slider-range").slider({ orientation: "vertical", range: true, min: 0, max: 12, values: [0, 11],
