...
(function () {
    WORLDMONGER.WaterMaterial = function (name, scene, light) {
        ...
        //this.bumpTexture = new BABYLON.Texture("static/game/babylon/Samples/Scenes/WorldMonger/Shaders/Water/bump.png", scene);
    ...
    WORLDMONGER.WaterMaterial.prototype.isReady = function (mesh) {
        ...
        //this._effect = engine.createEffect("static/game/babylon/Samples/Scenes/WorldMonger/Shaders/Water/water",
